...
search through every number and check the following products and return the largest product:

x-63 x-62 x-61 x-60 x-59 x-58 x-57
     x-42 x-41 x-40 x-39 x-38
          x-21 x-20 x-19
...
up: array[x] * array[x-20] * array[x-40] * array[x-60]
down: array[x] * array[x+20] * array[x+40] * array[x+60]
left: array[x] * array[x+1] * array[x+2] * array[x+3]
right: array[x] * array[x-1] * array[x-2] * array[x-3]
upleft: array[x] * array[x-21] * array[x-42] * array[x-63]
upright: array[x] * array[x-19] * array[x-38] * array[x-57]
downleft: array[x] * array[x+19] * array[x+38] * array[x+57]
downright: array[x] * array[x+21] * array[x+42] * array[x*63]


=end

def largest_product_of_grid(input)
  array = []
